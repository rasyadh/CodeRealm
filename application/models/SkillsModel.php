...
class SkillsModel extends CI_Model {
    ...
    function getAllPath($id_skill) {
        return $this->db->get_where('skill_path', array('id_skill'=>$id_skill));
    }

    function getPath($id_skill_path) {
        return $this->db->get_where('skill_path', array('id_skill_path'=>$id_skill_path));
    }
